...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), 'D:/Paco/WSTI 7 sem/OBRONA/WWW/symfony/app/cache/dev/annotations', true);
    }
    ...
    {
        $this->services['assetic.asset_manager'] = $instance = new \Assetic\Factory\LazyAssetManager($this->get('assetic.asset_factory'), array('twig' => new \Assetic\Factory\Loader\CachedFormulaLoader(new \Assetic\Extension\Twig\TwigFormulaLoader($this->get('twig')), new \Assetic\Cache\ConfigCache('D:/Paco/WSTI 7 sem/OBRONA/WWW/symfony/app/cache/dev/assetic/config'), true)));

        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($this->get('templating.loader'), '', 'D:/Paco/WSTI 7 sem/OBRONA/WWW/symfony/app/Resources/views', '/\\.[^.]+\\.twig$/'), 'twig');
    ...
    protected function getCacheWarmerService()
    {
        ...
        $c = new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplateFinder($a, $b, 'D:/Paco/WSTI 7 sem/OBRONA/WWW/symfony/app/Resources');
     ...
     * This method always returns the same instance of the service.
     *
     * @return EntityManager5175b0fd8fcfb_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager A EntityManager5175b0fd8fcfb_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager instance.
     */
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        require_once 'D:/Paco/WSTI 7 sem/OBRONA/WWW/symfony/app/cache/dev/jms_diextra/doctrine/EntityManager_5175b0fd8fcfb.php';

        $a = new \Doctrine\Common\Cache\ArrayCache();
        $a->setNamespace('sf2orm_default_b7d7c955c7eeecee437dbf5770ccbd6b');

        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_b7d7c955c7eeecee437dbf5770ccbd6b');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_b7d7c955c7eeecee437dbf5770ccbd6b');
        ...
        $d->setProxyDir('D:/Paco/WSTI 7 sem/OBRONA/WWW/symfony/app/cache/dev/doctrine/orm/Proxies');
        ...
        return $this->services['doctrine.orm.default_entity_manager'] = new \EntityManager5175b0fd8fcfb_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager($e, $this);
    }
    ...
    {
        return $this->services['file_locator'] = new \Symfony\Component\HttpKernel\Config\FileLocator($this->get('kernel'), 'D:/Paco/WSTI 7 sem/OBRONA/WWW/symfony/app/Resources');
    }
    ...
    {
        return $this->services['form.csrf_provider'] = new \Symfony\Component\Form\Extension\Csrf\CsrfProvider\SessionCsrfProvider($this->get('session'), '02289cfc71fdade2cfd2805088ab4145e4ffc367');
    }
    ...
    protected function getJmsDiExtra_Metadata_MetadataFactoryService()
    {
        ...
        $instance->setCache(new \Metadata\Cache\FileCache('D:/Paco/WSTI 7 sem/OBRONA/WWW/symfony/app/cache/dev/jms_diextra/metadata'));
    ...
    {
        return $this->services['monolog.handler.main'] = new \Monolog\Handler\StreamHandler('D:/Paco/WSTI 7 sem/OBRONA/WWW/symfony/app/logs/dev.log', 100, true);
    }
    ...
    protected function getProfilerService()
    {
        ...
        $this->services['profiler'] = $instance = new \Symfony\Component\HttpKernel\Profiler\Profiler(new \Symfony\Component\HttpKernel\Profiler\FileProfilerStorage('file:D:/Paco/WSTI 7 sem/OBRONA/WWW/symfony/app/cache/dev/profiler', '', '', 86400), $a);
    ...
    {
        return $this->services['router'] = new \Symfony\Bundle\FrameworkBundle\Routing\Router($this, 'D:/Paco/WSTI 7 sem/OBRONA/WWW/symfony/app/cache/dev/assetic/routing.yml', array('cache_dir' => 'D:/Paco/WSTI 7 sem/OBRONA/WWW/symfony/app/cache/dev', 'debug' => true, 'generator_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_base_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_dumper_class' => 'Symfony\\Component\\Routing\\Generator\\Dumper\\PhpGeneratorDumper', 'generator_cache_class' => 'appDevUrlGenerator', 'matcher_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_base_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_dumper_class' => 'Symfony\\Component\\Routing\\Matcher\\Dumper\\PhpMatcherDumper', 'matcher_cache_class' => 'appDevUrlMatcher', 'strict_requirements' => true), $this->get('router.request_context'), $this->get('monolog.logger.router'));
    }
    ...
    protected function getSecurity_Access_DecisionManagerService()
    {
        ...
        $a->setCacheDir('D:/Paco/WSTI 7 sem/OBRONA/WWW/symfony/app/cache/dev/jms_security/expressions');
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('D:/Paco/WSTI 7 sem/OBRONA/WWW/symfony/app/cache/dev/secure_random.seed', $this->get('monolog.logger.security'));
    }
    ...
    {
        return $this->services['sensio.distribution.webconfigurator'] = new \Sensio\Bundle\DistributionBundle\Configurator\Configurator('D:/Paco/WSTI 7 sem/OBRONA/WWW/symfony/app');
    }
    ...
    {
        return $this->services['session.handler'] = new \Symfony\Component\HttpFoundation\Session\Storage\Handler\NativeFileSessionHandler('D:/Paco/WSTI 7 sem/OBRONA/WWW/symfony/app/cache/dev/sessions');
    }
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('D:/Paco/WSTI 7 sem/OBRONA/WWW/symfony/app/cache/dev/sessions');
    }
    ...
    {
        return $this->services['templating.helper.code'] = new \Symfony\Bundle\FrameworkBundle\Templating\Helper\CodeHelper(NULL, 'D:/Paco/WSTI 7 sem/OBRONA/WWW/symfony/app', 'UTF-8');
    }
    ...
    protected function getTwigService()
    {
        ...
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'exception_controller' => 'twig.controller.exception:showAction', 'cache' => 'D:/Paco/WSTI 7 sem/OBRONA/WWW/symfony/app/cache/dev/twig', 'charset' => 'UTF-8', 'paths' => array()));
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\CodeExtension(NULL, 'D:/Paco/WSTI 7 sem/OBRONA/WWW/symfony/app', 'UTF-8'));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('D:\\Paco\\WSTI 7 sem\\OBRONA\\WWW\\symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Bridge\\Twig/Resources/views/Form');
        $instance->addPath('D:\\Paco\\WSTI 7 sem\\OBRONA\\WWW\\symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\FrameworkBundle/Resources/views', 'Framework');
        $instance->addPath('D:\\Paco\\WSTI 7 sem\\OBRONA\\WWW\\symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\SecurityBundle/Resources/views', 'Security');
        $instance->addPath('D:\\Paco\\WSTI 7 sem\\OBRONA\\WWW\\symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\TwigBundle/Resources/views', 'Twig');
        $instance->addPath('D:\\Paco\\WSTI 7 sem\\OBRONA\\WWW\\symfony\\vendor\\symfony\\swiftmailer-bundle\\Symfony\\Bundle\\SwiftmailerBundle/Resources/views', 'Swiftmailer');
        $instance->addPath('D:\\Paco\\WSTI 7 sem\\OBRONA\\WWW\\symfony\\vendor\\doctrine\\doctrine-bundle\\Doctrine\\Bundle\\DoctrineBundle/Resources/views', 'Doctrine');
        $instance->addPath('D:\\Paco\\WSTI 7 sem\\OBRONA\\WWW\\symfony\\src\\Acme\\DemoBundle/Resources/views', 'AcmeDemo');
        $instance->addPath('D:\\Paco\\WSTI 7 sem\\OBRONA\\WWW\\symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\WebProfilerBundle/Resources/views', 'WebProfiler');
        $instance->addPath('D:\\Paco\\WSTI 7 sem\\OBRONA\\WWW\\symfony\\vendor\\sensio\\distribution-bundle\\Sensio\\Bundle\\DistributionBundle/Resources/views', 'SensioDistribution');
        $instance->addPath('D:/Paco/WSTI 7 sem/OBRONA/WWW/symfony/app/Resources/views');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('02289cfc71fdade2cfd2805088ab4145e4ffc367');
    }
     ...
     *
     * @return EntityManager5175b0fd8fcfb_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager An instance of the doctrine.orm.default_entity_manager service
     */
    ...
    {
        $this->services['assetic.asset_factory'] = $instance = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), 'D:/Paco/WSTI 7 sem/OBRONA/WWW/symfony/app/../web', true);
    ...
    {
        return $this->services['assetic.cache'] = new \Assetic\Cache\FilesystemCache('D:/Paco/WSTI 7 sem/OBRONA/WWW/symfony/app/cache/dev/assetic/assets');
    }
    ...
    {
        $this->services['security.extra.metadata_factory'] = $instance = new \Metadata\MetadataFactory(new \Metadata\Driver\LazyLoadingDriver($this, 'security.extra.metadata_driver'), new \Metadata\Cache\FileCache('D:/Paco/WSTI 7 sem/OBRONA/WWW/symfony/app/cache/dev/jms_security', true));
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), 'D:/Paco/WSTI 7 sem/OBRONA/WWW/symfony/app/cache/dev');
    }
    ...
    {
        return $this->services['validator.mapping.class_metadata_factory'] = new \Symfony\Component\Validator\Mapping\ClassMetadataFactory(new \Symfony\Component\Validator\Mapping\Loader\LoaderChain(array(0 => new \Symfony\Component\Validator\Mapping\Loader\AnnotationLoader($this->get('annotation_reader')), 1 => new \Symfony\Component\Validator\Mapping\Loader\StaticMethodLoader(), 2 => new \Symfony\Component\Validator\Mapping\Loader\XmlFilesLoader(array(0 => 'D:\\Paco\\WSTI 7 sem\\OBRONA\\WWW\\symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/config/validation.xml')), 3 => new \Symfony\Component\Validator\Mapping\Loader\YamlFilesLoader(array()))), NULL);
    }
    ...
    {
        return array(
            'kernel.root_dir' => 'D:/Paco/WSTI 7 sem/OBRONA/WWW/symfony/app',
            'kernel.environment' => 'dev',
            'kernel.debug' => true,
            'kernel.name' => 'app',
            'kernel.cache_dir' => 'D:/Paco/WSTI 7 sem/OBRONA/WWW/symfony/app/cache/dev',
            'kernel.logs_dir' => 'D:/Paco/WSTI 7 sem/OBRONA/WWW/symfony/app/logs',
            ...
            'locale' => 'en',
            'secret' => '02289cfc71fdade2cfd2805088ab4145e4ffc367',
            'database_path' => NULL,
            ...
            'debug.container.dump' => 'D:/Paco/WSTI 7 sem/OBRONA/WWW/symfony/app/cache/dev/appDevDebugProjectContainer.xml',
            ...
            'kernel.secret' => '02289cfc71fdade2cfd2805088ab4145e4ffc367',
            ...
            'session.save_path' => 'D:/Paco/WSTI 7 sem/OBRONA/WWW/symfony/app/cache/dev/sessions',
            ...
            'validator.mapping.loader.xml_files_loader.mapping_files' => array(
                0 => 'D:\\Paco\\WSTI 7 sem\\OBRONA\\WWW\\symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/config/validation.xml',
            ),
            ...
            'profiler.storage.dsn' => 'file:D:/Paco/WSTI 7 sem/OBRONA/WWW/symfony/app/cache/dev/profiler',
            ...
            'router.resource' => 'D:/Paco/WSTI 7 sem/OBRONA/WWW/symfony/app/cache/dev/assetic/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => 'D:/Paco/WSTI 7 sem/OBRONA/WWW/symfony/app/cache/dev/twig',
                'charset' => 'UTF-8',
                'paths' => array(
            ...
            'swiftmailer.spool.memory.path' => 'D:/Paco/WSTI 7 sem/OBRONA/WWW/symfony/app/cache/dev/swiftmailer/spool',
            ...
            'assetic.cache_dir' => 'D:/Paco/WSTI 7 sem/OBRONA/WWW/symfony/app/cache/dev/assetic',
            ...
            'assetic.read_from' => 'D:/Paco/WSTI 7 sem/OBRONA/WWW/symfony/app/../web',
            'assetic.write_to' => 'D:/Paco/WSTI 7 sem/OBRONA/WWW/symfony/app/../web',
            ...
            'doctrine.orm.proxy_dir' => 'D:/Paco/WSTI 7 sem/OBRONA/WWW/symfony/app/cache/dev/doctrine/orm/Proxies',
            ...
            'jms_aop.cache_dir' => 'D:/Paco/WSTI 7 sem/OBRONA/WWW/symfony/app/cache/dev/jms_aop',
            ...
            'jms_di_extra.cache_dir' => 'D:/Paco/WSTI 7 sem/OBRONA/WWW/symfony/app/cache/dev/jms_diextra',
            'jms_di_extra.disable_grep' => false,
            'jms_di_extra.doctrine_integration' => true,
            'jms_di_extra.cache_warmer.controller_file_blacklist' => array(

            ),
            'jms_di_extra.doctrine_integration.entity_manager.file' => 'D:/Paco/WSTI 7 sem/OBRONA/WWW/symfony/app/cache/dev/jms_diextra/doctrine/EntityManager_5175b0fd8fcfb.php',
            'jms_di_extra.doctrine_integration.entity_manager.class' => 'EntityManager5175b0fd8fcfb_546a8d27f194334ee012bfe64f629947b07e4919\\__CG__\\Doctrine\\ORM\\EntityManager',
            ...
            'security.extra.cache_dir' => 'D:/Paco/WSTI 7 sem/OBRONA/WWW/symfony/app/cache/dev/jms_security',
